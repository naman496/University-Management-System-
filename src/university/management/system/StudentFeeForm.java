...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/fee1.jpg"));
        ...
        String course[] = {"B.Tech", "BBA", "BCA", "B.Sc", "M.sc", "M.B.A", "MCA", "M.Com", "MA", "BA"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                Conn c = new Conn();
                ResultSet rs = c.s.executeQuery("select * from fee where course_fees = '"+course+"'");
                while(rs.next()) {
            ...
            try {
                //Conn c = new Conn();
                //String query = "insert into paidfee values('"+rollno+"', '"+course+"', '"+branch+"', '"+semester+"', '"+total+"')";
